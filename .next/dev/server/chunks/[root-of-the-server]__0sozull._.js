...
async function PUT(request, context) {
    try {
        ...
        const targetIndex = currentUsers.findIndex((u)=>u.id === targetEmpId);
        if (targetIndex === -1) {
...
async function DELETE(request, context) {
    try {
        ...
        const targetEmpId = params.id;
        const currentUsers = readUsersFile();
        const filteredUsers = currentUsers.filter((u)=>u.id !== targetEmpId);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: "Profile scrubbed from master index."
        });
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Internal server error deleting employee."
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0sozull._.js.map